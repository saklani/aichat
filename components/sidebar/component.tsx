...
export function Sidebar() {
    ...
    return (
        <div className="border-r border-input flex flex-col w-[220px] h-screen px-[8px] gap-[4px]">
            <div className="h-[100px] pt-[12px]">
                <p className="text-2xl">RAG Search</p>
            </div>
            <Button onClick={() => router.push("/")} className={pathName === "/" ? "bg-accent" : ""} variant="sidebar">Agents</Button>
